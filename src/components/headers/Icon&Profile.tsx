...
export const IconAndProfile = ({session}: {session: any}) => {
  return <div className="flex items-center gap-6 max-lg:hidden">  
      <Users2 size={22} className="cursor-pointer text-gray-500 hover:text-blue-500 duration-75"/>
      <MessageCircleMore size={22} className="cursor-pointer text-gray-500 hover:text-blue-500 duration-75"/>
      <Bell size={22} className="cursor-pointer text-gray-500 hover:text-blue-500 duration-75"/>
